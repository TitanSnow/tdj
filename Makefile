...
bin/tdj-config: build/tdj-config.o build/config.o build/sql.o build/sqlite3.o
	g++ build/tdj-config.o build/config.o build/sql.o build/sqlite3.o -o bin/tdj-config -lpthread -ldl $(opt)
...
bin/tdj-localjudge: build/tdj-localjudge.o build/judger.o build/compare.o build/config.o build/sql.o build/time.o build/sqlite3.o
	g++ build/tdj-localjudge.o build/judger.o build/compare.o build/config.o build/sql.o build/time.o build/sqlite3.o -o bin/tdj-localjudge -lpthread -ldl $(opt)
...
bin/tdj-server: build/tdj-server.o build/config.o build/sql.o build/judger.o build/time.o build/compare.o build/sqlite3.o
	g++ build/tdj-server.o build/config.o build/sql.o build/judger.o build/time.o build/compare.o build/sqlite3.o -o bin/tdj-server -lpthread -ldl $(opt)
...
bin/tdj-broadcast: build/tdj-broadcast.o build/config.o build/sql.o build/sqlite3.o
	g++ build/tdj-broadcast.o build/config.o build/sql.o build/sqlite3.o -o bin/tdj-broadcast -lpthread -ldl $(opt)
...
bin/tdj-push: build/tdj-push.o build/time.o build/config.o build/sql.o build/sqlite3.o
	g++ build/tdj-push.o build/time.o build/config.o build/sql.o build/sqlite3.o -o bin/tdj-push -lpthread -ldl $(opt)
...
bin/tdj-listener: build/tdj-listener.o build/config.o build/sql.o build/sqlite3.o
	g++ build/tdj-listener.o build/config.o build/sql.o build/sqlite3.o -o bin/tdj-listener -lpthread -ldl $(opt)
...
build/sql.o: src/config/sql.cc lib/sqlite/sqlite3.h
	g++ -c src/config/sql.cc -o build/sql.o $(opt)
